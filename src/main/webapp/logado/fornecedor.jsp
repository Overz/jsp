                ...
                <table class="table_pesquisa">
                    ...
                    <c:forEach items="${fornecedores}" var="fornecedor">
                        <tr>
                            ...
                            <td>
                                <a
                                        href="/SitePetshop/crud_fornecedor?cmd=carregar&idTela=${fornecedor.id}"
                                >
                                    <img
                                            class="espaco_img"
                                ...
                                <a
                                        href="/SitePetshop/crud_fornecedor?cmd=excluir&idTela=${fornecedor.id}"
                                >
                                    <img
